    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans overflow-x-hidden relative selection:bg-orange-500 selection:text-white">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-orange-500 rounded-full blur-[120px] pointer-events-none" />
       <div className="absolute top-0 right-1/4 w-[400px] h-[400px] bg-fuchsia-500 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute top-1 center-15 w-[400px] h-[400px] bg-fuchsia-500 rounded-full blur-[140px] pointer-events-none" />
       <div className="absolute bottom-1/2 left-10 w-[500px] h-[500px] bg-fuchsia-500 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="absolute bottom-1/4 left-10 w-[400px] h-[400px] bg-orange-500 rounded-full blur-[140px] pointer-events-none" />
       <div className="absolute bottom-1/5 left-10 w-[400px] h-[400px] bg-fuchsia-500 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute bottom-2 right-10 w-[400px] h-[400px] bg-orange-500 rounded-full blur-[140px] pointer-events-none" />
