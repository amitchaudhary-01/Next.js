...
import { Building2, Plus, Trash2, RefreshCw, X, Users, MapPin, Tag } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 relative">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Manage Rooms & Properties</h1>
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={fetchRooms}
            className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-orange-600 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-700 cursor-pointer shadow-sm"
          >
            ...
            <form onSubmit={handleCreateRoom} className="space-y-4 pt-4">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button
                  ...
                  className="rounded-xl bg-orange-600 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-700 disabled:opacity-50 cursor-pointer flex items-center gap-2"
                >
                  {createLoading && (
